                ...
                child: Row(
                    children: [
                      Container(
                        ...
                        height: 54,
                        decoration: ShapeDecoration(
                          color: Color(0xff9a83f4).withOpacity(0.2),

                          shape: RoundedRectangleBorder(
                            side: BorderSide(color: Color(0xff9a83f4)),
                            borderRadius: BorderRadius.circular(10),
                          ),
                        ),
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'Enter text',
                                  hintStyle: TextStyle(color: Color(0xff9a83f4)),
                                ),
                                style: TextStyle(color: Color(0xff9a83f4)),
                              ),
                            ),
                            SizedBox(width: 10),
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                // onPrimary: Colors.black,
                                  backgroundColor: Color(0xff9a83f4).withOpacity(0.7),
                                  shape: CircleBorder(),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Align(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isUserInput ? Color(0xff9a83f4) : Color(0xff9a83f4).withOpacity(0.7),
                              borderRadius: BorderRadius.only(
