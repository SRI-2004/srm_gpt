...
class Summarys extends StatefulWidget {
  @override
  _SummarysState createState() => _SummarysState();
}
                ...
                child: Row(
                    children: [
                      Container(
                        ...
                        height: 54,
                        decoration: ShapeDecoration(
                          color: Color(0xfff8d05e).withOpacity(0.2),

                          shape: RoundedRectangleBorder(
                            side: BorderSide(color: Color(0xfff8d05e)),
                            borderRadius: BorderRadius.circular(10),
                          ),
                        ),
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'Enter text',
                                  hintStyle: TextStyle(color: Color(0xfff8d05e)),
                                ),
                                style: TextStyle(color: Color(0xfff8d05e)),
                              ),
                            ),
                            SizedBox(width: 10),
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                // onPrimary: Colors.black,
                                  backgroundColor: Color(0xfff8d05e).withOpacity(0.7),
                                  shape: CircleBorder(),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Align(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isUserInput ? Color(0xFFA0522D) : Color(0xFFA0522D).withOpacity(0.8),
                              borderRadius: BorderRadius.only(
