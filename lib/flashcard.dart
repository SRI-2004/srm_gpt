                ...
                child: Row(
                    children: [
                      Container(
                        ...
                        height: 54,
                        decoration: ShapeDecoration(
                          color: Color(0xFFE7595B).withOpacity(0.2),

                          shape: RoundedRectangleBorder(
                            side: BorderSide(color: Color(0xFFE7595B)),
                            borderRadius: BorderRadius.circular(10),
                          ),
                        ),
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'Enter text',
                                  hintStyle: TextStyle(color: Color(0xFFE7595B)),
                                ),
                                style: TextStyle(color: Color(0xFFE7595B)),
                              ),
                            ),
                            SizedBox(width: 10),
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                backgroundColor: Color(0xFFE7595B).withOpacity(0.7),
                                shape: CircleBorder(),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Align(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isUserInput ? Color(0xFFE7595B) : Color(0xFFE7595B).withOpacity(0.7),
                              borderRadius: BorderRadius.only(
